...
const WebDevelopment = () => {
  ...
  description="ვებსაიტის დამზადება. Next-Hub გთავაზობთ თანამედროვე ვებსაიტების, ონლაინ მაღაზიებისა და ვებ აპლიკაციების შექმნას. SEO ოპტიმიზაცია, სწრაფი ჩატვირთვა და ბიზნესზე მორგებული გადაწყვეტილებები."
...
>
  <div className="text-center mb-10">
    ...
    <p className="max-w-3xl mx-auto text-white/70 text-base md:text-lg leading-8">
      ...
      ბიზნესებისთვის, რომლებიც ონლაინ სივრცეში სანდოობასა და შედეგზე არის
      ორიენტირებული.
    </p>
  </div>
