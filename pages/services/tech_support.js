...
const TechSupport = () => {
  ...
  return (
    <>
      <NextSeo
        canonical={CANONICAL}
        title="საიტის მართვა | Next-Hub Solutions"
        description="ვებსაიტის ტექნიკური მხარდაჭერა ბიზნესისთვის: საიტის მოვლა, უსაფრთხოება, სიჩქარე, SEO კონტროლი, განახლებები და სტაბილური მუშაობა."
        openGraph={{
          type: "website",
          locale: "ka_GE",
          url: CANONICAL,
          ...
          title: "საიტის მართვა | Next-Hub Solutions",
          description:
            "ვებსაიტის ტექნიკური მხარდაჭერა ბიზნესისთვის: საიტის მოვლა, უსაფრთხოება, სიჩქარე, SEO კონტროლი, განახლებები და სტაბილური მუშაობა.",
          images: [
            {
        ...
        additionalMetaTags={[
          ...
          },
          {
            name: "keywords",
            content:
              "ვებსაიტის ტექნიკური მხარდაჭერა, საიტის ოპტიმიზაცია, website maintenance Georgia, website support Tbilisi, საიტის მოვლა, ვებსაიტის უსაფრთხოება, SEO ოპტიმიზაცია, ტექნიკური მხარდაჭერა თბილისი, Next-Hub Solutions",
          },
        ]}
      />
