  ...
  const serviceCards = [
    {
      ...
      href: "/webdevelopment",
      description:
        "ვამზადებთ სწრაფ და responsive ვებსაიტებს ბიზნესებისთვის, სანდო პრეზენტაციით, კონვერსიულ სტრუქტურით და SEO-ready საფუძვლით.",
    },
    {
      title: "პროგრამული უზრუნველყოფის შექმნა",
      href: "/software-development",
      description:
        "ვქმნით ვებ აპლიკაციებს, CRM სისტემებს, პორტალებს და სამუშაო პროცესებზე მორგებულ ციფრულ პროდუქტებს ბიზნესის ზრდისთვის ონლაინ.",
    },
    {
      title: "ვებ დიზაინი",
      href: "/web-design",
      description:
        "ვქმნით სუფთა და მარტივად გამოსაყენებელ ვებ დიზაინს, რომელიც ბრენდს სანდოდ აჩვენებს და მომხმარებელს მოქმედებამდე მიჰყავს.",
    },
    {
      title: "SEO ოპტიმიზაცია",
      href: "/seo-services",
      description:
        "SEO მომსახურება მოიცავს ტექნიკურ აუდიტს, keyword კვლევას, გვერდების ოპტიმიზაციას, კონტენტს და Search Console-ის გამართვას.",
    },
    {
      title: "Google Business Profile ოპტიმიზაცია",
      href: "/google-business-profile-optimization",
      description:
        "Google Business Profile ოპტიმიზაცია ეხმარება ლოკალურ ბიზნესს Google Maps-ში, ძიებაში და მომხმარებლის არჩევანის მომენტში.",
    },
    {
