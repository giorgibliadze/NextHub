...
`;
      ...
      const isVerified = verify(
        "sha256",
        Buffer.from(JSON.stringify(req.body)), // We need to ensure the body is a Buffer of a stringified object
        {
          key: publicKey,
      ...
      if (event === "order_payment") {
        ...
        // Add your logic to handle the payment details, e.g., save to the database
