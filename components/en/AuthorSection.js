      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
        ...
        <div>
          ...
          <p className="text-sm leading-7 text-white/68 md:text-base md:leading-8">
            {author} creating websites, web design, SEO optimization, software systems, and site maintenance strategies for businesses that need not only a beautiful page, but a measurable digital outcome.
          </p>
        </div>
      </div>
    </section>
