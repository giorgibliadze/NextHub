...
export default function CTASection({
  title = "Do you want this to be the same for your business?",
  text = "contact Next-Hub Solutions- and we can work together to build the website, develop the website, provide the SEO service or optimize the Google Business Profile.",
}) {
  return (
