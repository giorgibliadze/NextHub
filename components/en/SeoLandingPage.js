        ...
        >
          ...
          <div className="mb-10 md:mb-12 rounded-3xl bg-accent/10 border border-accent/30 p-5 md:p-8">
            ...
            <p className="text-white/75 leading-7 md:leading-8 mb-5 text-sm md:text-base">
              Next-Hub Solutions provides {page.serviceType}. The company is based in Tbilisi, Georgia, and helps businesses create fast, mobile-friendly, SEOready, conversion-focused digital experiences.
            </p>
            <Link
              href="/en/ai-faq"
