...
const url = "https://next-hub.pro/en/blog/seo";

export const metadata = {
  title: "SEO tips and articles.",
  ...
  alternates: getLanguageAlternates("/en/blog/seo"),
  openGraph: {
    title: "SEO tips and articles.",
    description: category.description,
    url,
...
export default function SeoBlogCategoryPage() {
  return <CategoryPage category={category} posts={getPostsByCategory("seo")} />;
}
