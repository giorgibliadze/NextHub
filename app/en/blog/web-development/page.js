...
const url = "https://next-hub.pro/en/blog/web-development";
...
export const metadata = {
  ...
  alternates: getLanguageAlternates("/en/blog/web-development"),
  openGraph: {
    title: "Web design.",
    description: category.description,
    url,
...
export default function WebDevelopmentBlogCategoryPage() {
  const posts = getPostsByCategory("web-development");
